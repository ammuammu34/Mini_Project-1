...
public class PdfGenerator {
	...
	public void generatePDF(List<CitizenPlan> plans,FileOutputStream fos) {
		...
		for(CitizenPlan c : plans) {
			...
			table.addCell(c.getPlanNames());
			table.addCell(c.getStatus());
			table.addCell(String.valueOf(c.getStartDate()));
			table.addCell(String.valueOf(c.getEndDate()));
			table.addCell(String.valueOf(c.getBenifitAmount()));
			table.addCell(c.getDenialReason());
			table.addCell(String.valueOf(c.getTerminatedDate()));
			table.addCell(c.getTerminalReason());
